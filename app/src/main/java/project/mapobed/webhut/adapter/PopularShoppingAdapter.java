...
public class PopularShoppingAdapter extends RecyclerView.Adapter<PopularShoppingAdapter.PopularWebsiteHolder> {
    private final List<PopularWebsiteModalClass>list;
    private final pop_website_link_clicked pop_website_link_clicked;

    public PopularShoppingAdapter(List<PopularWebsiteModalClass> list, PopularShoppingAdapter.pop_website_link_clicked pop_website_link_clicked) {
        this.list = list;
    ...
    class PopularWebsiteHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            pop_website_link_clicked.link_clicked_shopping(getAdapterPosition());
        }
    }
    public interface pop_website_link_clicked{
        void link_clicked_shopping(int name);
    }
}
