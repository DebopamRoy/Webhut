...
public class PopularClassifiedAdapter extends RecyclerView.Adapter<PopularClassifiedAdapter.PopularWebsiteHolder> {
    private final List<PopularWebsiteModalClass>list;
    private final pop_website_link_clicked pop_website_link_clicked;

    public PopularClassifiedAdapter(List<PopularWebsiteModalClass> list, PopularClassifiedAdapter.pop_website_link_clicked pop_website_link_clicked) {
        this.list = list;
    ...
    class PopularWebsiteHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            pop_website_link_clicked.link_clicked_classified(getAdapterPosition());
        }
    }
    public interface pop_website_link_clicked{
        void link_clicked_classified(int name);
    }
}
