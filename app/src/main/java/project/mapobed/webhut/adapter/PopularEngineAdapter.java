...
public class PopularEngineAdapter extends RecyclerView.Adapter<PopularEngineAdapter.PopularWebsiteHolder> {
    private final List<PopularWebsiteModalClass>list;
    private final pop_website_link_clicked pop_website_link_clicked;

    public PopularEngineAdapter(List<PopularWebsiteModalClass> list, PopularEngineAdapter.pop_website_link_clicked pop_website_link_clicked) {
        this.list = list;
    ...
    class PopularWebsiteHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            pop_website_link_clicked.link_clicked_engine(getAdapterPosition());
        }
    }
    public interface pop_website_link_clicked{
        void link_clicked_engine(int name);
    }
}
