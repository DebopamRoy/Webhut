...
public class PopularDoubtAdapter extends RecyclerView.Adapter<PopularDoubtAdapter.PopularWebsiteHolder> {
    private final List<PopularWebsiteModalClass>list;
    private final pop_website_link_clicked pop_website_link_clicked;

    public PopularDoubtAdapter(List<PopularWebsiteModalClass> list, PopularDoubtAdapter.pop_website_link_clicked pop_website_link_clicked) {
        this.list = list;
    ...
    class PopularWebsiteHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            pop_website_link_clicked.link_clicked_doubt(getAdapterPosition());
        }
    }
    public interface pop_website_link_clicked{
        void link_clicked_doubt(int name);
    }
}
