...
public class PopularEntertainmentAdapter extends RecyclerView.Adapter<PopularEntertainmentAdapter.PopularWebsiteHolder> {
    private final List<PopularWebsiteModalClass>list;
    private final pop_website_link_clicked pop_website_link_clicked;

    public PopularEntertainmentAdapter(List<PopularWebsiteModalClass> list, PopularEntertainmentAdapter.pop_website_link_clicked pop_website_link_clicked) {
        this.list = list;
    ...
    class PopularWebsiteHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            pop_website_link_clicked.link_clicked_entertainment(getAdapterPosition());
        }
    }
    public interface pop_website_link_clicked{
        void link_clicked_entertainment(int name);
    }
}
